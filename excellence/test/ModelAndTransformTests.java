...
public class ModelAndTransformTests {
    ...
    public void testMoveTransform() {
        ...
        model.setSpeed(2);
        assertEquals("rectangle:\"R1\" posn=(0.0,0.0); size=(15.000000, 25.000000); color=java.awt.Color[r=255,g=0,b=0]", model.getShapes().get(0).toString());
    ...
    public void testColorApply() {
        ...
        model.createShape(oval1);
        cc2.apply(oval1);
        assertEquals("oval:\"C\" posn=(50.0,50.0); size=(10.000000, 10.000000); color=java.awt.Color[r=0,g=255,b=0]", model.getShapes().get(0).toString());
    ...
    public void testOpsSVG() {
        ...
        assertEquals("<animate attributeType=\"xml\" begin=\"1000ms\" dur=\"200ms\" attributeName=\"fill\" " +
