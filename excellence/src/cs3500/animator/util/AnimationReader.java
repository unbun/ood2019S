...
/**
 * A helper to read animator data and construct an animator from it.
 */
public class AnimationReader {
     ...
     * alphabetic strings with no spaces), giving the unique name of the shape, and the typeStr of
     * shape it is.</li>
