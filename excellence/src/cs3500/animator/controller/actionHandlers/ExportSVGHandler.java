...
/**
 * Action listener class that creates an SVG file for the animation to be exported when the
...
public class ExportSVGHandler implements ActionListener {
   ...
   */
  public ExportSVGHandler(ControllableView view, AnimationModel model, Appendable ap)
      throws IOException {
    this.view = view;
    this.model = model;
    this.ap = ap;
