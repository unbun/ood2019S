...
public class TriangleGame implements ModelCommand {
  ...
  /**
   * Command to create an triangle model with the given size and a default hole.
   *
  ...
  /**
   * Command to create a triangle model with a given size and the given hole.
   *
   * @param size the specified size
