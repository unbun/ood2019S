...
/**
 * A class to represent and retrieve a valid input that the {@code MarbleSolitaireController}
 * can receive.
 */
public final class ValidInput {
  ...
  /**
   * A class to representand retreive a valid input that the {@code MarbleSolitaireController}
   * can receive.
   *
