...
public interface ShapeAction {
  ...
  InstantShapeAction initCreateAction(int startTime);

  boolean isShapeInitalized();
  ...
  /**
   * Get the start time of this action. NOTE: This is just for this assignment, so that the model
   * only updates animations once, and the animation description is cleaner.
   */
  int getStartTime();
