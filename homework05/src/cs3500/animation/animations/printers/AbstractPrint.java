...
/**
 * <p>Design Justification: For now, we are just implementing the model, which only needs to keep track
 * of the state of each animation. But we need an output to ensure that the model is properly
...
public abstract class AbstractPrint extends AbstractShapeAction {
  ...
  /**
   * Constructs an AbstractShapePrintAction with the given startTime and endTime to be applied to the given
   * shape in the given model.
   *
